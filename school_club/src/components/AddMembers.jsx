  ...
  return (
    <React.Fragment>
      <div>
        ...
        <form
          className="col-xl-6 col-lg-7 col-md-8 col-sm-9 col-10 pr-0 pt-2 pb-0 px-0 pt-sm-4 pb-sm-4 px-sm-4"
        ...
        >
          ...
          <button
            className="btn btn-info ml-2 ml-sm-2 ml-md-2 ml-lg-2 ml-xl-3 mb-3 "
            type="submit"
            value="Submit"
          >
            Add
